...
contract DSCEngineTest is Test {
    ...
    function testGetTokenAmountFromUsd() public {
        ...
        // if $2,000 per ETH, we have $100 = 100 / 2000 = 0.05 ether
    ...
    function testCanDepositCollateralAndGetAccountInfo() public depositedCollateral {
        ...
        // 10 ether * 2000 = $20,000 (collateralValueInUsd)
    ...
    //    MintDsc Tests    //
    /////////////////////////
    // This test needs its own custom setup
    ...
    function testRevertsIfMintAmountIsZero2() public depositedCollateralAndMintedDsc {
        vm.expectRevert(DSCEngine.DSCEngine__NeedsMoreThanZero.selector);
        dsce.mintDsc(0);
    }
    ...
    function testCanMintDsc2() public depositedCollateralAndMintedDsc {
    ...
    function testRevertsIfRedeemAmountIsZero2() public depositedCollateral {
        vm.startPrank(USER);
        ERC20Mock(weth).approve(address(dsce), AMOUNT_COLLATERAL);
        vm.expectRevert(DSCEngine.DSCEngine__NeedsMoreThanZero.selector);
        dsce.redeemCollateral(weth, 0);
    ...
    function testCanRedeemDepositedCollateral2() public depositedCollateralAndMintedDsc {
        vm.startPrank(USER);
        dsc.approve(address(dsce), amountToMint);
        dsce.redeemCollateralForDsc(weth, AMOUNT_COLLATERAL, amountToMint);
        vm.stopPrank();
    ...
    function testMustImproveHealthFactorOnLiquidation() public {
        ...
        // Act
        int256 ethUsdUpdatePrice = 18e8; // 1 ETH = $18
    ...
    function testUserStillHasSomeEthAfterLiquidation() public liquidated {
        ...
        (, uint256 userCollateralValueInUsd) = dsce.getAccountInfomation(USER);
    ...
    function testLiquidatorTakesOnUsersDebt() public liquidated {
        (uint256 liquidatorDscMinted,) = dsce.getAccountInfomation(liquidator);
        assertEq(liquidatorDscMinted, amountToMint);
    }

    function testUserHasNoMoreDebt() public liquidated {
        (uint256 userDscMinted,) = dsce.getAccountInfomation(USER);
    ...
    function testGetAccountCollateralValueFromInformation() public depositedCollateral {
        (, uint256 collateralValue) = dsce.getAccountInfomation(USER);
    ...
    function testGetAccountCollateralValue() public {
        ...
        uint256 expectedColllateralValue = dsce.getUsdValue(weth, AMOUNT_COLLATERAL);
        assertEq(collateralValue, expectedColllateralValue);
    }
